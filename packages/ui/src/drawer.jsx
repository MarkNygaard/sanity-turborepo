...
var DrawerOverlay = React.forwardRef(function (_a, ref) {
    ...
    return (<vaul_1.Drawer.Overlay ref={ref} className={(0, ui_1.cn)("fixed inset-0 z-50 bg-black/80", className)} {...props}/>);
});
...
var DrawerContent = React.forwardRef(function (_a, ref) {
    ...
    return (<DrawerPortal>
    <DrawerOverlay />
    <vaul_1.Drawer.Content ref={ref} className={(0, ui_1.cn)("fixed inset-x-0 bottom-0 z-50 mt-24 flex h-auto flex-col rounded-t-[10px] border bg-background", className)} {...props}>
...
var DrawerHeader = function (_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (<div className={(0, ui_1.cn)("grid gap-1.5 p-4 text-center sm:text-left", className)} {...props}/>);
};
exports.DrawerHeader = DrawerHeader;
DrawerHeader.displayName = "DrawerHeader";
var DrawerFooter = function (_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (<div className={(0, ui_1.cn)("mt-auto flex flex-col gap-2 p-4", className)} {...props}/>);
};
exports.DrawerFooter = DrawerFooter;
DrawerFooter.displayName = "DrawerFooter";
var DrawerTitle = React.forwardRef(function (_a, ref) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (<vaul_1.Drawer.Title ref={ref} className={(0, ui_1.cn)("text-lg font-semibold leading-none tracking-tight", className)} {...props}/>);
});
exports.DrawerTitle = DrawerTitle;
DrawerTitle.displayName = vaul_1.Drawer.Title.displayName;
var DrawerDescription = React.forwardRef(function (_a, ref) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (<vaul_1.Drawer.Description ref={ref} className={(0, ui_1.cn)("text-sm text-muted-foreground", className)} {...props}/>);
});
