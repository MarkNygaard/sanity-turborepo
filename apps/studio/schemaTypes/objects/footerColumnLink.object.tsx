...
export const footerColumnLinkObject = defineType({
  name: 'footerColumnLink',
  type: 'object',
  title: 'Footer Column Link',
  icon: TbLink,
  description: 'A link within a footer column',
  fields: [
    defineField({
      name: 'name',
      type: 'string',
      title: 'Link Text',
      description: 'The text that will be displayed for this footer link',
...
export default footerColumnLinkObject
